...
export default class WorkSignUpStepFour extends Component {
        ...
        return (
            <View style={styles.headerComponentView}>
                <View style={[styles.contentItemView, styles.contentSignStepView]}>
                    <Image source={Images.img_bg_step4} style={CusTheme.signUpStepImg} />
                    <View style={styles.contentSignStepConView}>
                        ...
                        <Text style={[styles.contentSignStepContext, styles.contentSignStepContextCur]}>完成工作</Text>
                    </View>
                </View>
    ...
    render() {
        ...
        let pageTitle = params && params.pageTitle ? params.pageTitle : '完成工作';
        return (
            <View style={styles.container}>
                ...
                <Button
                    ...
                    onPress={() => RouterHelper.navigate('首页', 'Home')}
                />
            </View>
        );
    }
